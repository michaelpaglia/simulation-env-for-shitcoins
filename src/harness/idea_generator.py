...
Be specific and creative. Each idea should be distinct."""
    ...
    def _generate_fallback(self, num_ideas: int) -> list[GeneratedIdea]:
        ...
        # Mix of good, mediocre, and bad ideas for realistic distribution
        templates = [
            # Good ideas
            GeneratedIdea(
                name="Based Dog",
            ...
            # Mediocre ideas - higher risk
            GeneratedIdea(
                name="SafeYield Protocol",
                ticker="SAFEY",
                narrative="Guaranteed 1000% APY through innovative tokenomics",
                tagline="Your funds are SAFU",
                meme_style=MemeStyle.ABSURD,
                hook="Trust us bro, it's safe",
                target_audience="yield farmers",
                strategy=IdeaStrategy.TREND_CHASE,
                reasoning="Yield narrative still attracts liquidity",
                risk_factors=["Sounds like a rug", "Unsustainable promises", "Red flag name"],
                confidence=0.25,
            ),
            GeneratedIdea(
                name="ElonTrumpAI",
                ticker="ETAI",
                narrative="What if Elon and Trump had an AI baby that traded crypto?",
                tagline="Make Crypto Great Again, to Mars",
                meme_style=MemeStyle.TOPICAL,
                hook="Combining the two most memed figures in one token",
                target_audience="political degens",
                strategy=IdeaStrategy.TOPICAL,
                reasoning="Name recognition drives initial interest",
                risk_factors=["Lawsuit bait", "Polarizing", "Cringe factor"],
                confidence=0.3,
            ),
            # Bad ideas - likely to fail
            GeneratedIdea(
                name="RugSafe",
                ticker="RUGSAFE",
                narrative="We promise this one won't rug. Pinky swear.",
                tagline="Definitely not a rug",
                meme_style=MemeStyle.EDGY,
                hook="Ironic rug insurance",
                target_audience="gamblers",
                strategy=IdeaStrategy.CONTRARIAN,
                reasoning="Irony might land with some",
                risk_factors=["Name is a red flag", "Attracts wrong attention", "Self-fulfilling prophecy"],
                confidence=0.15,
            ),
            GeneratedIdea(
                name="Blockchain Integration Solutions Token",
                ticker="BIST",
                narrative="Enterprise-grade blockchain solutions for B2B SaaS integration",
                tagline="Synergizing the decentralized paradigm",
                meme_style=MemeStyle.ABSURD,
                hook="Corporate buzzword bingo as a token",
                target_audience="no one",
                strategy=IdeaStrategy.AVANT_GARDE,
                reasoning="So boring it might be funny?",
                risk_factors=["No meme potential", "Zero virality", "Sounds like a scam"],
                confidence=0.1,
            ),
            GeneratedIdea(
                name="CopyPasteDoge",
                ticker="CPDOGE",
                narrative="It's like Doge but we copied the code exactly",
                tagline="Why innovate when you can duplicate",
                meme_style=MemeStyle.CUTE,
                hook="Blatant copy with zero shame",
                target_audience="confused normies",
                strategy=IdeaStrategy.TREND_CHASE,
                reasoning="Doge worked so this should too right?",
                risk_factors=["Zero differentiation", "Legal issues", "Community rejection"],
                confidence=0.2,
            ),
            GeneratedIdea(
                name="AnonymousFounder",
                ticker="ANON",
                narrative="Founded by someone. We can't tell you who. Trust.",
                tagline="In anon we trust",
                meme_style=MemeStyle.EDGY,
                hook="Mystery founder = definitely not a rug",
                target_audience="risk seekers",
                strategy=IdeaStrategy.CONTRARIAN,
                reasoning="Mystique can drive speculation",
                risk_factors=["Obvious rug signals", "No accountability", "CT will destroy this"],
                confidence=0.15,
            ),
            GeneratedIdea(
                name="YesterdaysMeme",
                ticker="YESTER",
                narrative="Remember that meme from 2 weeks ago? We made a coin for it.",
                tagline="Always fashionably late",
                meme_style=MemeStyle.NOSTALGIC,
                hook="Intentionally missing the trend",
                target_audience="slowpokes",
                strategy=IdeaStrategy.NOSTALGIA,
                reasoning="Being late is the new early?",
                risk_factors=["Missed timing", "Stale narrative", "No momentum"],
                confidence=0.2,
            ),
        ]
